...
class FollowerProvider extends ChangeNotifier {
  ...
  Future _storeItemsInCache() async {
    await Environment.instance.cache.setCache("followers.json", jsonEncode(followers));
    await Environment.instance.cache.setCache("followers.json", jsonEncode(following));
  }
}
