...
<template>
    <tbody>
        <tr>
            <td>
                <ElCheckbox v-if="!allowMoreTeams()" :model-value="checkboxValue()" @update:model-value="(e) => $emit('onUpdate', e)" :disabled="inputDisabled()" :id="checkbox"/>
                <ElSelect v-if="allowMoreTeams()" :model-value="props.registration?.team || ''" @update:model-value="(e) => $emit('onUpdate', e)" :disabled="inputDisabled()">
