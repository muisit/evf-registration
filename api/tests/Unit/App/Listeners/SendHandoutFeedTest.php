...
use App\Listeners\SendHandoutFeed;
...
class SendHandoutFeedTest extends TestCase
{
    ...
    public function testHandle()
    {
        ...
        $ev = new AccreditationHandoutEvent($doc->accreditation);
        ...
        $this->setForFollowers(DeviceUserData::DEVICEUSER1, "handout");
        $this->setForFollowing(DeviceUserData::DEVICEUSER2, FencerData::MCAT1, "handout", true);
        $this->setForFollowing(DeviceUserData::DEVICEUSER3, FencerData::MCAT1, "handout", true);

        $listener = new SendHandoutFeed();
        $listener->handle($ev);
        $feeds = DeviceFeed::all();
    ...
    public function testHandleUser()
    {
        ...
        $this->setForFollowers(DeviceUserData::DEVICEUSER1, "handout");
        $this->setForFollowing(DeviceUserData::DEVICEUSER2, FencerData::MCAT1, "handout", false);
        $this->setForFollowing(DeviceUserData::DEVICEUSER3, FencerData::MCAT1, "handout", false);
