...
class GetTest extends TestCase
{
    public function testRoute()
    {
        ...
        $response = $this->get('/ranking/me/1')->assertStatus(200);
        $response = $this->get('/ranking/me/2')->assertStatus(200);
        $response = $this->get('/ranking/me/3')->assertStatus(200);
        $response = $this->get('/ranking/me/4')->assertStatus(200);
        $response = $this->get('/ranking/ms/1')->assertStatus(200);
        $response = $this->get('/ranking/ms/2')->assertStatus(200);
        $response = $this->get('/ranking/ms/3')->assertStatus(200);
        $response = $this->get('/ranking/ms/4')->assertStatus(200);
        $response = $this->get('/ranking/wf/1')->assertStatus(200);
        $response = $this->get('/ranking/wf/2')->assertStatus(200);
        $response = $this->get('/ranking/wf/3')->assertStatus(200);
        $response = $this->get('/ranking/wf/4')->assertStatus(200);
        $response = $this->get('/ranking/we/1')->assertStatus(200);
        $response = $this->get('/ranking/we/2')->assertStatus(200);
        $response = $this->get('/ranking/we/3')->assertStatus(200);
        $response = $this->get('/ranking/we/4')->assertStatus(200);
